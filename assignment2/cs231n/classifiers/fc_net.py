...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        H, cache_hidden = affine_relu_forward(X, self.params['W1'], self.params['b1'])
        ...
        dscores, grads['W2'], grads['b2'] = affine_backward(d_loss, cache_scores)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache['scores'] = affine_forward(H, W, b) 
        ...
        dscores, grads[Wname], grads[bname] = affine_backward(d_loss, cache['scores'])
